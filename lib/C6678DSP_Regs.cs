...
namespace Jungo.c6678dsp_lib
{
    ...
    public class C6678DSP_Regs
    {
        private const uint WDC_AD_CFG_SPACE = 0xFF;
        public readonly WDC_REG[] gC6678DSP_CfgRegs = new WDC_REG[]
        {
        ...
        public readonly WDC_REG[] gC6678DSP_RT_Regs = 
        {
            new WDC_REG((DWORD)PCI_BARS.AD_PCI_BAR0, 0x54, wdc_lib_consts.WDC_SIZE_32, WDC_DIRECTION.WDC_READ_WRITE, "INTCSR", "")
        };
    };
